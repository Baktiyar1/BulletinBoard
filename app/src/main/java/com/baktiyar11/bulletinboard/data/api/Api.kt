...
interface Api {
    ...
    suspend fun getAllRealEstate(
        @Query("where") id: String,
    ): Response<RealEstateResponse>?

    @GET("classes/Taxi")
    suspend fun getAllTaxi(
        @Query("where") id: String,
    ): Response<TaxiResponse>?

    @GET("classes/Electronics")
    suspend fun getAllElectronics(
        @Query("where") id: String,
    ): Response<ElectronicsResponse>?
    ...
    @GET("classes/Work")
    suspend fun getAllWork(
        @Query("where") id: String,
    ): Response<WorkResponse>?

    @GET("classes/PersonalItems")
    suspend fun getAllPersonalItems(
        @Query("where") id: String,
    ...
    suspend fun getAllSportAndHobbies(
        @Query("where") id: String,
    ): Response<SportAndHobbiesResponse>?

    @GET("classes/MedicalProducts")
    suspend fun getAllMedicalProducts(
        @Query("where") id: String,
    ): Response<MedicalProductsResponse>?

    @GET("classes/ChildrenWord")
    suspend fun getAllChildrenWord(
        @Query("where") id: String,
    ): Response<ChildrenWordResponse>?

    @GET("classes/GiveForFree")
    suspend fun getAllGiveForFree(
        @Query("where") id: String,
    ): Response<GiveForFreeResponse>?
}