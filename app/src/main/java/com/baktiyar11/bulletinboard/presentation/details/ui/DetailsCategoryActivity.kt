...
class DetailsCategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            backMainMenu.setOnClickListener {
                startActivity(Intent(this@DetailsCategoryActivity,
    ...
    private fun getAllTransport(category: Category) {
    ...
    private fun getAllRealEstate(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllTaxi(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllElectronics(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllServices(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllWork(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllPersonalItems(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllAnimals(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllSportAndHobbies(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllMedicalProducts(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllChildrenWorld(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
    ...
    private fun getAllGiveForFree(category: Category) {
        lifecycleScope.launch(Dispatchers.IO) {
            val response =
